...
Eight locks were located in Hamden: locks 13-20. Lock 18, known as the "Goodyear lock" was located near Centerville. This lock was situated opposite the Goodyear House, a tavern on the Cheshire Turnpike. In March 1834, a lock in Hamden was entirely replaced, and the "long level" was deepened to address the water deficiency problems that had previously plagued the area.
